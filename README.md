...
The last artifact is Grazioso Salvare Dashboard from CS 340 Advanced Programming Concepts, which showcases database-driven application skills. I enhanced the MongoDB CRUD module by improving database connection handling, implementing safer input validation, refining error messages, and adding CSV fallback loading. These enhancements ensured that if the MongoDB database was unavailable, the dashboard could still display table data, breed distribution charts, and geolocation maps. These enhancements also show that I can improve database reliability and keep an application running even when unexpected errors occur.
...
As I continue to develop my computer science skills, I plan to apply them to practical tool development, systems engineering, automation, visualization, and 3D modeling.
...
[View Original Files](https://github.com/zzronzz/ePortfolio/tree/main/enhancement-one-software-design/original)

[View Enhanced Files](https://github.com/zzronzz/ePortfolio/tree/main/enhancement-one-software-design/enhanced)
